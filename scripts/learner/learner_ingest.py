...
import learner_llm
from paths import CHAPTER_MAPPING, INPUT_ICELANDIC
...
def main():
    ...
    parser.add_argument('--mapping', default=str(CHAPTER_MAPPING), help='Path to chapter mapping file')
    parser.add_argument('--audio-folder', default=str(INPUT_ICELANDIC), help='Folder containing transcript JSONs')
